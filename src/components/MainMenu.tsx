...
export function MainMenu({ onJoin, className }: MainMenuProps) {
    ...
    return (
        <div className={cn("flex flex-col md:flex-row gap-6 w-full max-w-4xl mx-auto h-[500px]", className)}>
            {/* Left Col: Menu & Auth */}
            <div className="flex-1 flex flex-col gap-6 bg-neutral-900/80 p-6 rounded-2xl border-2 border-neutral-800 shadow-2xl backdrop-blur-md">
                <div>
                    <h2 className="text-xl font-bold text-white mb-2 uppercase tracking-wider text-emerald-400">Trainer Profile</h2>
                    <input
                        type="text"
                        ...
                        maxLength={16}
                        className="w-full px-4 py-3 rounded-xl bg-neutral-800 text-white border-2 border-neutral-700 focus:outline-none focus:border-emerald-500 transition-colors font-bold"
                    />
                </div>

                <div className="flex-1 flex flex-col gap-4">
                    <h2 className="text-xl font-bold text-white uppercase tracking-wider text-emerald-400 mt-4">Play Game</h2>
